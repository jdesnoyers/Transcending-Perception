...
public class RealRotaryPotentiometer : MonoBehaviour {
    ...
    [SerializeField] [ColorUsage(true, true, 0f, 8f, 0.125f, 3f)] private Color zeroColor = Color.green;
    [SerializeField] [ColorUsage(true, true, 0f, 8f, 0.125f, 3f)] private Color fullColor = Color.red;
    ...
    void PotKnobHandler(MidiChannel channel, int knob, float value)
    {
        ...
        {
            if(knob==108)   //if it's the encoder button, switch the anticipated encoder input knob
            {
    ...
    void displayValue(string input, float value, bool global = false)
    {
        ...
        GetComponent<Renderer>().material.SetColor("_EmissionColor", Color.Lerp(zeroColor, fullColor, value));
